...
subscription_id = "c512c90e-a994-49b9-90f2-b226572fb0bc"
...
def build_image(run_id, model_name):
    ...
    aci_service_name = "motion-detection-model-dev"+ str(uuid.uuid4())[:4]
...
if __name__ == "__main__":
    ...
    '''
    try:
        df = pd.read_csv("/home/milosv/Desktop/mlflow-fresh/project/motion_final_part_0.csv")
        ...
        logger.info("Dataset {} has been sucesfully read!","/home/milosv/Desktop/mlflow-fresh/project/motion_final_part_0.csv")
